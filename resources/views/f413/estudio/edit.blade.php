...
<div class="container">
  <div class="card border-danger mb-3" style="max-width: 256rem;">
    <div class="card-header"><h5>Estudio de la Institucion</h5></div>
      <div class="card-body">
        <form action="{{route('estudios.update', $estudio->id)}}" method="post" role="form">
          {{ csrf_field() }}
{{--           @include('f413.estudio._form_edit')
 --}}
{{--         <div class="form-group">
          ...
          <div class="col-md-6">
            <div class="form-group{{ $errors->has('fec_envio') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                ...
                <input id="fec_envio" type="date" class="form-control" name="fec_envio" value="{{$estudio->fec_envio}}" required="required">
              </div>
          ...
          <div class="col-md-6">
            <div class="form-group{{ $errors->has('fec_respuesta') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                ...
                <input id="fec_respuesta" type="date" class="form-control" name="fec_respuesta" value="{{$estudio->fec_respuesta}}" required="required">
              </div>
          ...
          <div class="col-md-4">
            <div class="form-group{{ $errors->has('num_exp_supervision') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                ...
                <input id="num_exp_supervision" type="number" class="form-control" name="num_exp_supervision" value="{{$estudio->num_exp_supervision}}" required="required">
              </div>
          ...
          <div class="col-md-4">
            <div class="form-group{{ $errors->has('num_oficio_siss') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                ...
                <input id="num_oficio_siss" type="number" class="form-control" name="num_oficio_siss" value="{{$estudio->num_oficio_siss}}" required="required">
              </div>
          ...
          <div class="col-md-4">
            <div class="form-group{{ $errors->has('num_entrega') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                ...
                <input id="num_entrega" type="number" class="form-control" name="num_entrega" value="{{$estudio->num_entrega}}" required="required">
              </div>
        ...
        <div class="form-row">
          <div class="col-md-6">
            ...
            <div class="input-group-prepend">
              ...
              <input id="aport_trabajador" type="number" class="form-control" name="aport_trabajador" value="{{$estudio->aport_trabajador}}" required="required">
            </div>
            ...
            <div class="col-md-6">
              ...
              <div class="input-group-prepend">
                ...
                <input id="aport_patron" type="number" class="form-control" name="aport_patron" value="{{$estudio->aport_patron}}" required="required">
              </div>
          ...
          <div class="col-md-3">
            <div class="form-group{{ $errors->has('fijos_act') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                ...
                <input id="fijos_act" type="number" class="form-control" name="fijos_act" value="{{$estudio->fijos_act}}" required="required">
              </div>
          ...
          <div class="col-md-3">
            <div class="form-group{{ $errors->has('contratados_act') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                ...
                <input id="contratados_act" type="number" class="form-control" name="contratados_act" value="{{$estudio->contratados_act}}" required="required">
              </div>
          ...
          <div class="col-md-3">
            <div class="form-group{{ $errors->has('otros_act') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                ...
                <input id="otros_act" type="number" class="form-control" name="otros_act" value="{{$estudio->otros_act}}" placeholder="alto nivel, elección popular, etc." required="required">
              </div>
          ...
          <div class="col-md-3">
            <div class="form-group{{ $errors->has('nomina_adic') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                ...
                <input id="nomina_adic" type="number" class="form-control" name="nomina_adic" value="{{$estudio->nomina_adic}}" required="required">
              </div>
          ...
          <div class="col-md-4">
            <div class="form-group{{ $errors->has('jubiladas') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                ...
                <input id="jubiladas" type="number" class="form-control" name="jubiladas" value="{{$estudio->jubiladas}}" required="required">
              </div>
          ...
          <div class="col-md-4">
            <div class="form-group{{ $errors->has('jubilados') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                ...
                <input id="jubilados" type="number" class="form-control" name="jubilados" value="{{$estudio->jubilados}}" required="required">
              </div>
          ...
          <div class="col-md-4">
            <div class="form-group{{ $errors->has('jubilados_bs_anual') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                ...
                <input id="jubilados_bs_anual" type="number" class="form-control" name="jubilados_bs_anual" value="{{$estudio->jubilados_bs_anual}}" required="required">
              </div>
        ...
        <div class="form-row">
          <div class="col-md-4">
            <div class="form-group{{ $errors->has('pensionadas_i') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                <span class="input-group-text">Mujeres</span>
                <input id="pensionadas_i" type="number" class="form-control" name="pensionadas_i" value="{{$estudio->pensionadas_i}}" required="required">
              </div>
          ...
          <div class="col-md-4">
            <div class="form-group{{ $errors->has('pensionados_i') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                <span class="input-group-text">Hombres</span>
                <input id="pensionados_i" type="number" class="form-control" name="pensionados_i" value="{{$estudio->pensionados_i}}" required="required">
              </div>
          ...
          <div class="col-md-4">
            <div class="form-group{{ $errors->has('pensionados_i_bs_anual') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                <span class="input-group-text">Monto anual Bs.</span>
                <input id="pensionados_i_bs_anual" type="number" class="form-control" name="pensionados_i_bs_anual" value="{{$estudio->pensionados_i_bs_anual}}" required="required">
              </div>
        ...
        <div class="form-row">
          <div class="col-md-4">
            <div class="form-group{{ $errors->has('pensionadas_s') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                <span class="input-group-text">Mujeres</span>
                <input id="pensionadas_s" type="number" class="form-control" name="pensionadas_s" value="{{$estudio->pensionadas_s}}" required="required">
              </div>
          ...
          <div class="col-md-4">
            <div class="form-group{{ $errors->has('pensionados_s') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                <span class="input-group-text">Hombres</span>
                <input id="pensionados_s" type="number" class="form-control" name="pensionados_s" value="{{$estudio->pensionados_s}}" required="required">
              </div>
          ...
          <div class="col-md-4">
            <div class="form-group{{ $errors->has('pensionados_s_bs_anual') ? ' has-error' : '' }}">
              <div class="input-group-prepend">
                <span class="input-group-text">Monto anual Bs.</span>
                <input id="pensionados_s_bs_anual" type="number" class="form-control" name="pensionados_s_bs_anual" value="{{$estudio->pensionados_s_bs_anual}}" required="required">
              </div>
        ...
        <div class="form-group">
          <div class="input-group-prepend">
            ...
            <input name="orig_recursos" value="{{$estudio->orig_recursos}}" class="form-control" type="textarea">
          </div>
        </div>
        <div class="form-group">
          <div class="input-group-prepend">
            <span class="input-group-text">Observaciones</span>
            <input name="observaciones" id="observaciones" value="{{$estudio->observaciones}}" class="form-control" type="textarea" placeholder="Indique alguna observaciones, si existe" rows="3">
          </div>
        </div>
