...
<div class="container">
  <div class="card border-danger mb-3" style="max-width: 256rem;">
    <div class="card-header"><h5>Usuario de la SiSS</h5></div>
      <div class="card-body">
        <form action="{{ route('usuarios.update', $usuario->id)}}" method="post" role="form">
          {{ method_field('put') }}
          {{ csrf_field() }}
          <div class="form-row">
            <div class="col-md-6">
              <div class="form-group{{ $errors->has('cedula') ? ' has-error' : '' }}">
                <div class="input-group-prepend">
                  ...
                  <input id="cedula" type="number" class="form-control" name="cedula" value="{{$usuario->cedula}}" required="required">
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('tlf') ? ' has-error' : '' }}">
                  <div class="input-group-prepend">
                    ...
                    <input id="tlf" type="number" pattern="[0-9]{11}" class="form-control" name="tlf" value="{{$usuario->tlf}}" required="required">
                  </div>
                  @if ($errors->has('tlf'))
                    <span class="help-block">
                      <div class="alert alert-danger">
              ...
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('name1') ? ' has-error' : '' }}">
                  <div class="input-group-prepend">
                    ...
                    <input id="name1" type="text" class="form-control" name="name1" value="{{$usuario->name1}}" required="required">
                  </div>
                  @if ($errors->has('name1'))
                    <span class="help-block">
                      <div class="alert alert-danger">
              ...
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('name2') ? ' has-error' : '' }}">
                  <div class="input-group-prepend">
                    ...
                    <input id="name2" type="text" class="form-control" name="name2" value="{{$usuario->name2}}">
                  </div>
                  @if ($errors->has('name2'))
                    <span class="help-block">
                      <div class="alert alert-danger">
              ...
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('lastname1') ? ' has-error' : '' }}">
                  <div class="input-group-prepend">
                    ...
                    <input id="lastname1" type="text" class="form-control" name="lastname1" value="{{$usuario->lastname1}}" required="required">
                  </div>
              ...
              <div class="col-md-6">
                <div class="form-group{{ $errors->has('lastname2') ? ' has-error' : '' }}">
                  <div class="input-group-prepend">
                    ...
                    <input id="lastname2" type="text" class="form-control" name="lastname2" value="{{$usuario->lastname2}}">
                  </div>
          ...
          <div class="form-row">
            <div class="col-md-6">
              <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                <div class="input-group-prepend">
                  ...
                  <input id="email" type="email" class="form-control" name="email" value="{{$usuario->email}}" required="required">
                </div>
                @if ($errors->has('email'))
                  <span class="help-block">
                    <div class="alert alert-danger">
            ...
            <div class="col-md-6">
              <div class="input-group-prepend">
                <label class="input-group-text">Permisos de:</label>
